...
#! 
#! 26 primitive operations were used to derive 49 operations for this category
#! which algorithmically
#! * IsCategoryWithTerminalObject
#! * IsSymmetricMonoidalCategory
m := LinearizationOfSetMonoid( Zmat, FullTransformationMonoid( 2 ) );
Assert( 0, IsWellDefined( m ) );
Assert( 0, IsWellDefined( DualBimonoid( m ) ) );
...
#! 
#! 27 primitive operations were used to derive 66 operations for this category
#! which algorithmically
#! * IsSymmetricMonoidalCategory
#! * IsCategoryWithZeroObject
g := LinearizationOfSetGroup( Zmat, CyclicGroup( 4 ) );
Assert( 0, IsWellDefined( g ) );
Assert( 0, IsWellDefined( DualHopfMonoid( g ) ) );
