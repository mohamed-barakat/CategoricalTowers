...
#!
DeclareAttribute( "AffineVarietyOfHopfMonoids", IsInternalMonoid );

#!
DeclareAttribute( "AffineVarietyOfHopfMonoids", IsInternalComonoid );
...
DeclareOperation( "HopfMonoid",
        [ IsInternalBimonoid, IsList ] );
#!
DeclareOperation( "HopfMonoid",
        [ IsInternalBimonoid, IsRecord ] );

DeclareOperation( "HopfMonoid",
        [ IsInternalMonoid, IsList, IsList, IsList ] );
#!
DeclareOperation( "HopfMonoid",
        [ IsInternalMonoid, IsRecord, IsRecord, IsRecord ] );
