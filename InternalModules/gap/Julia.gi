...
InstallOtherMethod( Bimonoid,
        [ IsInternalMonoid and HasUnderlyingAlgebra, IsJuliaObject, IsJuliaObject ],
...
InstallOtherMethod( HopfMonoid,
        [ IsInternalMonoid and HasUnderlyingAlgebra, IsJuliaObject, IsJuliaObject, IsJuliaObject ],
