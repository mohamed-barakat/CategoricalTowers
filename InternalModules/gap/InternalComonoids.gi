  ...
  function( B )
    ...
    object_constructor :=
      function( ComonB, triple_of_object_counit_comultiplication )
        ...
        Assert( 0,
                Length( triple_of_object_counit_comultiplication ) = 3 and
                IsCapCategoryObject( triple_of_object_counit_comultiplication[1] ) and
                ForAll( triple_of_object_counit_comultiplication{[ 2 .. 3 ]}, IsCapCategoryMorphism ) and
                ForAll( triple_of_object_counit_comultiplication, cell -> IsIdenticalObj( B, CapCategory( cell ) ) ) );
    ...
    ##
    object_datum := { ComonB, comonoid } -> DefiningTripleOfInternalComonoid( comonoid );
    ...
    morphism_constructor :=
      function ( ComonB, source, morphism, target )
        ...
        Assert( 0,
                ...
                IsIdenticalObj( CapCategory( morphism ), UnderlyingCategory( ComonB ) ) );
    ...
    ##
    morphism_datum := { ComonB, comonoid_morphism } -> UnderlyingMorphism( comonoid_morphism );
    ...
    ComonB :=
      ReinterpretationOfCategory( opMon_opB,
              rec( name := Concatenation( "CategoryOfComonoids( ", Name( B ), " )" ),
                   ...
                   category_object_filter := IsInternalComonoid,
                   category_morphism_filter := IsInternalComonoidMorphism,
