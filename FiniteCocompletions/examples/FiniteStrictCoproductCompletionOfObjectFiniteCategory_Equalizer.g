...
f_1 := MorphismConstructor( mT, x, [ [ [ [ 0, 0, 0 ], [ 1, 0, 2 ] ] ], [ [ id_T, id_T, id_T ] ] ], x );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
f_2 := MorphismConstructor( mT, x, [ [ [ [ 0, 0, 0 ], [ 0, 2, 1 ] ] ], [ [ id_T, id_T, id_T ] ] ], x );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
D := [ f_1, f_2 ];;
eq := Equalizer( mT, D );
...
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
f_2 := MorphismConstructor( mT, x, [ [ [ [ 0, 0, 0 ], [ 1, 0, 1 ] ] ], [ [ id_T, id_T, id_T ] ] ], x );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
D := [ f_1, f_2 ];;
eq := Equalizer( mT, D );
...
#! <An object in FiniteStrictCoproductCompletionOfObjectFiniteCategory( TerminalC\
#! ategoryWithSingleObject( ) )>
tau := MorphismConstructor( mT, t, [ [ [ [ 0 ], [ 1 ] ] ], [ [ id_T ] ] ], x );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
l := UniversalMorphismIntoEqualizer( mT, x, D, t, tau );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
PairOfLists( l )[1];
#! [ [ [ 0 ], [ 1 ] ] ]
...
#! <An object in FiniteStrictCoproductCompletionOfObjectFiniteCategory( TerminalC\
#! ategoryWithSingleObject( ) )>
f_1 := MorphismConstructor( mT, x, [ [ [ [ 0, 0, 0, 0 ], [ 0, 0, 1, 2 ] ] ], [ [ id_T, id_T, id_T, id_T ] ] ], y );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
f_2 := MorphismConstructor( mT, x, [ [ [ [ 0, 0, 0, 0 ], [ 0, 0, 2, 2 ] ] ], [ [ id_T, id_T, id_T, id_T ] ] ], y );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
f_3 := MorphismConstructor( mT, x, [ [ [ [ 0, 0, 0, 0 ], [ 0, 0, 0, 2 ] ] ], [ [ id_T, id_T, id_T, id_T ] ] ], y );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
D := [ f_1, f_2, f_3 ];;
eq := Equalizer( mT, D );
...
#! <An object in FiniteStrictCoproductCompletionOfObjectFiniteCategory( TerminalC\
#! ategoryWithSingleObject( ) )>
tau := MorphismConstructor( mT, t, [ [ [ [ 0, 0 ], [ 3, 1 ] ] ], [ [ id_T, id_T ] ] ], x );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
#! CategoryWithSingleObject( ) )>
l := UniversalMorphismIntoEqualizer( mT, x, D, t, tau );
#! <A morphism in FiniteStrictCoproductCompletionOfObjectFiniteCategory( Terminal\
